...
var filterwert = document.getElementById("formGroupExampleInput1").value;
document.addEventListener('DOMContentLoaded', tabelleGeladen, false);

function tabelleGeladen() {
  document.getElementById('tabelleladen').addEventListener('click', tabelleGeladen, false);
      ...
      .then((alldata) => {
          if (document.getElementById("formGroupExampleInput1").value != "") {
              if (sortieroption === "Sortieroption wählen") {
                  ...
                  let filterdata = alldata.filter(filterdata => filterdata.land === filterwert || filterdata.unternehmen === filterwert);
